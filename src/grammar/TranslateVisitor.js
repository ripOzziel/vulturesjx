...
export default class TranslateVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by TranslateParser#whileSentencia.
	...
	// Visit a parse tree produced by TranslateParser#incremento.
	visitIncremento(ctx) {
	  return this.visitChildren(ctx);
	}
