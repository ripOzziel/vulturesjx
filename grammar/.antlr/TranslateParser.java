...
public class TranslateParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, MAIN=4, IF=5, PRINT=6, TRUE=7, FALSE=8, ELSE=9, 
		ELSEIF=10, VOID=11, WHILE=12, INT=13, FLOAT=14, STRING=15, CHAR=16, LPAREN=17, 
		RPAREN=18, LBRACE=19, RBRACE=20, FIN=21, PLUS=22, MINUS=23, TIMES=24, 
		DIV=25, EQUALS=26, ID=27, NUMBER=28, STRINGL=29, CHARL=30, IGUAL=31, DISTINTO=32, 
		MAYOR=33, MENOR=34, MAYORIGUAL=35, MENORIGUAL=36, AND=37, OR=38, NOT=39, 
		DIGIT=40, RESI=41, WS=42;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "','", "'++'", "'--'", "'main'", "'if'", "'printf'", "'true'", 
			"'false'", "'else'", "'else if'", "'void'", "'while'", "'int'", "'float'", 
			"'string'", "'char'", "'('", "')'", "'{'", "'}'", "';'", "'+'", "'-'", 
			"'*'", "'/'", "'='", null, null, null, null, "'=='", "'!='", "'>'", "'<'", 
			"'>='", "'<='", "'&&'", "'||'", "'!'", null, "'%'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "MAIN", "IF", "PRINT", "TRUE", "FALSE", "ELSE", 
			"ELSEIF", "VOID", "WHILE", "INT", "FLOAT", "STRING", "CHAR", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "FIN", "PLUS", "MINUS", "TIMES", "DIV", 
			"EQUALS", "ID", "NUMBER", "STRINGL", "CHARL", "IGUAL", "DISTINTO", "MAYOR", 
			"MENOR", "MAYORIGUAL", "MENORIGUAL", "AND", "OR", "NOT", "DIGIT", "RESI", 
			"WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 134328416L) != 0)) {
				{
				{
				setState(49);
				content();
