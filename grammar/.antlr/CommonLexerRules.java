...
public class CommonLexerRules extends Lexer {
	...
	public static final int
		...
		OR=23, NOT=24, PRINT=25, IF=26, ELSE=27, ELSEIF=28, NUM=29, VUL=30, V=31, 
		ID=32, NUMBER=33, STRING=34, CHAR=35, WS=36, SALTO=37, TRUE=38, FALSE=39;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NOT", "PRINT", "IF", "ELSE", "ELSEIF", "NUM", "VUL", "V", "ID", "NUMBER", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'&'", "','", "'('", "')'", "'{'", "'}'", "'=='", "'!='", "'>'", "'<'", 
			"'>='", "'<='", "'&&'", "'||'", "'!'", "'printPlease'", "'if'", "'else'", 
			"'elseif'", "'num'", "'vul'", "'v'", null, null, null, null, null, "'\\n'", 
			"'true'", "'false'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OR", "NOT", "PRINT", "IF", "ELSE", "ELSEIF", "NUM", "VUL", "V", "ID", 
			"NUMBER", "STRING", "CHAR", "WS", "SALTO", "TRUE", "FALSE"
		};
	}
